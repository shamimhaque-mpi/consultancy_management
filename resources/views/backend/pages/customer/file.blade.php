...
<script type="text/javascript">
	...
	function fetch_data ($data=null){
		var where = {
			url  : "{{url('admin/customer/api_get_file')}}",
			type : "POST",
		}
			...
			[
				{
					...
					render:function(t,a,e,l){
						return `
							<a href="{{url('/')}}/admin/customer/file/${e.id}/edit" class="btn btn-sm btn-clean btn-icon" title="File Process"><i class="la la-edit"></i></a>
						`
					}
				}
			]
