					...
					<div class="col-xl-8">
						<div class="my-5">
							...
							<div class="form-group row">
								...
								<div class="col-9">
									<input type="text" name="name" value="{{old('name') ?? $user->name}}" class="@error('name') is-invalid @enderror form-control form-control-solid" placeholder="Enter Your Full Name" required>
								</div>
							...
							<div class="form-group row">
								...
								<div class="col-9">
									<input type="text" name="address" class="form-control form-control-solid" placeholder="Adresss" value="{{old('address') ?? $user->address}}" />
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-9">
									<div class="input-group input-group-solid">
										...
										<input name="mobile" type="text" class="@error('mobile') is-invalid @enderror form-control form-control-solid" value="{{old('mobile') ?? $user->mobile}}" placeholder="Mobile Number" required>
										@error('mobile')
							...
							<div class="form-group row">
								...
								<div class="col-9">
									<div class="input-group input-group-solid">
										...
										<input name="email" type="email" class="@error('email') is-invalid @enderror form-control form-control-solid" value="{{old('email') ?? $user->email}}" placeholder="Email" required>
										@error('email')
										<div class="fv-plugins-message-container">
						...
						<div class="form-group row">
							...
							<div class="col-9">
								<div class="input-group input-group-solid">
									<input type="text" class="form-control form-control-solid" value="{{$user->username}}" placeholder="Username" readonly>
						...
						<div class="form-group row">
							...
							<div class="col-9">
								<div class="input-group input-group-solid">
									<input name="password" type="password" class="form-control form-control-solid" placeholder="Password">
									@error('password')
									<div class="fv-plugins-message-container">
						...
						<div class="form-group row">
							...
							<div class="col-9">
								<div class="input-group input-group-solid">
									<input name="confirm_password" type="password" class="form-control form-control-solid" placeholder="Confirm Password">
