			...
			<form onsubmit="filter(event)" class="mb-15">
				<div class="row mb-6">
					<div class="col-lg-3 mb-lg-0 mb-6">
						...
						<input type="text" id="category_name" class="form-control datatable-input" placeholder="E.G: CSN Category" />
					</div>
...
<script type="text/javascript">
	...
	function fetch_data ($data=null){
		var where = {
				url:"{{url('admin/category/api_get_all')}}",
				type:"POST",
			}
			...
			[
				{
					...
					render:function(t,a,e,l){
						return `
							<a href="{{url('/')}}/admin/category/${e.id}/edit" class="btn btn-sm btn-clean btn-icon" title="Edit details"><i class="la la-edit"></i></a>
							<a href="{{url('admin/category/trash')}}/${e.id}" onclick="return confirm('Are You Sure Delete This Data??')" class="btn btn-sm btn-clean btn-icon" title="Delete Data"><i class="la la-trash"></i></a>
						`
					}
				}
			]
