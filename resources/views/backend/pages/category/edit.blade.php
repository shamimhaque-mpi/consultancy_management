...
@section('content')
	...
	<div class="card card-custom">
		...
		<div class="card-body">
			<!--begin::Form-->
			<form class="form" id="agent_from" method="POST" action="{{route('category.update', $category->id)}}">
				@csrf
				<div class="row">
					...
					<div class="col-xl-8">
						<div class="my-5">
							...
							<div class="form-group row">
								...
								<div class="col-9">
									<input type="text" name="category_name" value="{{old('category_name') ?? $category->category_name}}" class="@error('shop_name') is-invalid @enderror form-control form-control-solid" placeholder="Enter Category Name" required>
									@error('category_name')
