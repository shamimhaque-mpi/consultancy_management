...
<form>
	...
	<div class="table-responsive">
		<table class="table table-bordered">
			<tr>
				...
				<th>Customer</th>
				<td>{{$file->customer->customer_name ?? 'N/A'}}</td>
			</tr>
			<tr>
				<th>Shop</th>
				<td colspan="3">
	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class=" form-group">
				<input type="text" value="{{$file->designation}}" class="form-control" readonly>
			</div>
		</div>
		...
		<div class="col-md-6">
			<label>Name</label>
			<div class=" form-group">
				<input type="text" value="{{$file->name}}" class="form-control" required>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-4">
			<label>Common</label>
			<div class=" form-group">
				<input type="text" name="common" value="{{$file->common}}" class="form-control" readonly>
			</div>
		</div>
		...
		<div class="col-md-4">
			<label>Address</label>
			<div class=" form-group">
				<input type="text" name="address" value="{{$file->address}}" class="form-control"readonly>
			</div>
		</div>
		...
		<div class="col-md-4">
			...
			<div class=" form-group">
				<input type="text" name="postal_code" value="{{$file->postal_code}}" class="form-control"readonly>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class=" form-group">
				<input type="text" name="telephone" value="{{$file->telephone}}" class="form-control"readonly>
			</div>
		</div>
		...
		<div class="col-md-6">
			<label>E-mail</label>
			<div class=" form-group">
				<input type="text" name="email" value="{{$file->email}}" class="form-control"readonly>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class=" form-group">
				<input type="text" name="ordinary_or_standard_isee" value="{{$file->ordinary_or_standard_isee}}" class="form-control"readonly>
			</div>
		</div>
		...
		<div class="col-md-3">
			...
			<div class=" form-group">
				<input type="text" name="isee_universita" value="{{$file->isee_universita}}" class="form-control"readonly>
			</div>
		</div>
		...
		<div class="col-md-3">
			...
			<div class=" form-group">
				<input type="text" name="isee_for_minors" value="{{$file->isee_for_minors}}" class="form-control"readonly>
			</div>
		</div>
		...
		<div class="col-md-3">
			...
			<div class=" form-group">
				<input type="text" name="isee_socio_sanitario" value="{{$file->isee_socio_sanitario}}" class="form-control"readonly>
			</div>
		</div>
		...
		<div class="col-md-3">
			...
			<div class=" form-group">
				<input type="text" name="current_isee" value="{{$file->current_isee}}" class="form-control"readonly>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class=" form-group">
				<input type="text" name="household" value="{{$file->household}}" class="form-control"readonly>
			</div>
		</div>
		...
		<div class="col-md-3">
			...
			<div class=" form-group">
				<input type="text" name="house_rent_property_other" value="{{$file->house_rent_property_other}}" class="form-control"readonly>
			</div>
		</div>
	</div>
